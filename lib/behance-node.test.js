...
(0, globals_1.describe)("Behance node module", () => {
	...
	(0, globals_1.beforeAll)(async () => {
		...
		projectTest = randomProject["url"].replace(
	...
	(0, globals_1.test)("It should return desired project data", () => {
		Behance_1.default.project(projectTest).then((result) => {
			(0, globals_1.expect)(result).not.toBeNull();
		});
	});
	/**
	...
	(0, globals_1.test)(
		...
		() => {
			Behance_1.default.randomProject().then((result) => {
				(0, globals_1.expect)(result).not.toBeNull();
			});
		},
	);
	(0, globals_1.test)(
		...
		() => {
			Behance_1.default.randomProject("recommended").then((result) => {
				(0, globals_1.expect)(result).not.toBeNull();
			});
		},
	);
	(0, globals_1.test)("It should ignore time argument because sort", () => {
		Behance_1.default.randomProject("curated", "all_time").then((result) => {
			(0, globals_1.expect)(result).not.toBeNull();
		});
	});
	(0, globals_1.test)(
		...
		() => {
			Behance_1.default
				.randomProject("most_appreciated", "this_week")
				.then((result) => {
					(0, globals_1.expect)(result).not.toBeNull();
				});
		},
	...
	(0, globals_1.test)(
		"It should return a random project sort by most commented and this week",
		() => {
			Behance_1.default
				.randomProject("most_commented", "all_time")
				.then((result) => {
					(0, globals_1.expect)(result).not.toBeNull();
				});
		},
